...
dataset = dataset[0:dataset_size]
...
data_with_perturbed_responses = get_constiutional_perturbations(data_with_original_rewards,
                                                                constitutional_principles=constitutional_principles,
                                                                constitution_meta_data={"ccai_group": ccai_group}
                                                                )
...
augmented_dataset = Dataset.from_list(data_with_perturbed_rewards)
